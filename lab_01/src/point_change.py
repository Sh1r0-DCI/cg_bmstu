...
def get_point_coord(listb_f_set):
...
def process(window, entry_x, entry_y, listb_f_set, listb_f_cursel):
    try:
...
def point_change(window, listb_f_set):
    cur_coord = get_point_coord(listb_f_set)
